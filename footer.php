<footer class="page-footer" style="margin-top: 120px; box-shadow: 0px 0px 2px white; background-color: rgb(17,17,17)">
  <div class="row wide-container">
    ...
    <div class="col s2">
      ...
      <p class="bold">
        Monday to Sunday : <br> 08.00am to 20.00pm
      </p>
      <p class="bold">
        842/1 Nguyen Kiem St, Go Vap Dist, HCM City <br>
      </p>
    </div>
    <div class="col s2">
  ...
  <div class="footer-copyright" style="padding-bottom: 20px; display: flex; justify-content: center; align-items:center;">
    <div class="wide-container underline">© 2025 Tech PC All rights reserved.</div>
  </div>
